...
class ProjectListingSerializer(serializers.ModelSerializer):
    ...
    def get_developer_name(obj):
        try:
            return obj.agent.first_name + " " + obj.agent.last_name
        except Exception as exp:
            return ""
...
class DeveloperProjectDetailStepOneSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DeveloperProject
        fields = ("id", "project_name", "city", "neighborhood", "community", "address_one", "postal_code", "project_selected_facilities",
                  ...
                  "project_lon", "create_step", "country", "domain", "status", "project_status_id")
