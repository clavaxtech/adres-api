...
class SubdomainAgentDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Users
        fields = ("id", "first_name", "last_name", "email", "phone_no", "address_first", "state", "postal_code", "status", "profile_image")
    ...
    class Meta:
        ...
        fields = ("id", "profile_image", "first_name", "last_name", "email", "phone_no",
                  "address_first", "state", "postal_code", "property_cnt", "project_cnt", "added_on",
                    "approval", "last_login", "is_upgrade", "user_status", "employee_cnt")
...
class UserProfileDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "profile_image", "first_name", "last_name", "email", "phone_no", "address", "described_by",
                  ...
                  "is_account_verified", "phone_country_code", "is_email_verified", "account_rejection_reason")
...
class EmployeeListingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "profile_image", "first_name", "last_name", "email", "phone_no",
                  "address_first", "state", "postal_code", "property_cnt", "project_cnt", "added_on",
                    "approval", "last_login", "is_upgrade", "user_status")
...
class EmployeeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Users
        fields = ("id", "first_name", "last_name", "email", "phone_no", "address_first", "state", "postal_code", "status", "profile_image", "developer")
